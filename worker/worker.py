...
compute_opts = [
    cfg.StrOpt('rabbitmq_host', required=True, help='RabbitMQ server hostname for compute'),
    cfg.StrOpt('transport_url', required=True, help='RabbitMQ transport URL for compute'),
    cfg.StrOpt('curator_topic', required=True, help='RPC topic for curator'),
    cfg.StrOpt('worker_host', default=socket.gethostname(), help='Compute node hostname')
]
...
target = oslo_messaging.Target(topic=CONF.worker.curator_topic, namespace='curator',  version='2.0')
